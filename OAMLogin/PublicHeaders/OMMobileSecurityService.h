...
/**
 * Updates value of cookies in NSHTTPCookieStorage. No new cookies are added
 * and the value is updated only if the received cookie's name, domain and path
 * match with the pre-existing cookie.
 *
 ...
 *                    server
 * @return            TRUE if atleast one cookie was updated. FALSE if error
 *                    occured or no cookie was updated.
 */
